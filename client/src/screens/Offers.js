...
import shakes from './shakes.jpeg';
import shake from './shake.webp'
// import shakes from './shakes.jpeg';
import shake1 from './shake1.webp'
import './Offers.css';
            ...
            <div className="d-flex">
                <div className="container" style={{ width: "40%", height: "100vh" }}>
                    <div className="photoback" style={{ height: "90%", width: "80%", marginLeft: "13rem", marginTop: "6rem" }}>
                        <img src={shake1} style={{ height: "100%", width:"95%" }}></img>
                    </div>
                </div>
                                ...
                                {coupons.map(coupon => (
                                    <div key={coupon._id} className="coupon-item d-flex">
                                        <div className="coupon-details">
                                            <div>
                                                <h5 style={{ color: "aquamarine" }}> ~ {coupon.coupon_code}</h5>
